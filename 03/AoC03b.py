...
while i<len(data)-minlen[mode]:
    ...
    #Search for do or don't independent of mode
    if data[i:min(len(data),i+4)]=="do()":
        fdo = 1
    
    if data[i:min(len(data),i+7)]=="don't()":
        fdo = 0
